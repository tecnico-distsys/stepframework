...
public class NoFlightAvailableForReservationException extends FlightDomainException {
    ...
    public NoFlightAvailableForReservationException(String message, Throwable cause) {
	super(message, cause);
    }
