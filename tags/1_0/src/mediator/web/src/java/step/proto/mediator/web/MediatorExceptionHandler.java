...
public class MediatorExceptionHandler implements AutoExceptionHandler {
    ...
    public Resolution handle(Exception ex, HttpServletRequest request, HttpServletResponse response) {
	...
	bean.getContext().getMessages().add(new LocalizableMessage("msg.booking.failed", reason));
