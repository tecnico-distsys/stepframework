 ...
 */
public class HandlerChicago implements SOAPHandler<SOAPMessageContext> {

    public HandlerChicago() {
    ...
    public boolean handleMessage(SOAPMessageContext smc) {
        ...
        if (outboundProperty.booleanValue()) {
            ...
            if(false) {
                ...
                throw new RuntimeException("Server Outbound - Runtime Exception!");
            }
            if(false) {
                System.out.println(this + " throwing soap fault exception");
                throw new SOAPFaultException(handler.CreateSOAPFaultUtil.createFault("Server Outbound - SOAP Fault!"));
            }
            if(false) {
            ...
            if(false) {
                System.out.println(this + " throwing runtime exception");
                throw new RuntimeException("Server Inbound - Runtime Exception!");
            }
            if(false) {
                System.out.println(this + " throwing soap fault exception");
                throw new SOAPFaultException(handler.CreateSOAPFaultUtil.createFault("Server Inbound - SOAP Fault!"));
            }
            if(false) {
                System.out.println(this + " returning false");
                return false;
