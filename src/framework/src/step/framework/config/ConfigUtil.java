...
public class ConfigUtil {
    ...
    public static Properties getResourceAsProperties(String resourcePath) {
        ...
        try {
            ...
            log.debug("caught io exception when reading resource file " +
                      resourcePath + "; returning null", e);
            return null;
        } finally {
            try {
                if(is != null)
                ...
                log.debug("caught io exception while closing InputStream; ignoring", e);
            }
        }
        return newProps;
    }
