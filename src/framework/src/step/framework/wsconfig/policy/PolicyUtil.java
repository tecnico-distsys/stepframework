...
public class PolicyUtil {
	...
	public static Policy getPolicy(SOAPHeaderElement header) throws Exception
	{
		String policy = header.getTextContent();
		if(policy == null || policy.length() == 0)
			throw new Exception("Empty policy header.");
		
		return PolicyEngine.getPolicy(toOM(policy));
	}
