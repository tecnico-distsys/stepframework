...
if (generateSchema) {
    // (re)create tables
    Helper.exec("../flight-ws", "ant -e hibernatetool", ["CLASSPATH" : ""])
...
argv = ["-p", config.perf.flight.databasePropertiesFile as String,
        ...
        "--file", config.perf.flight.domain.airports.file as String,
...
argv = ["-p", config.perf.flight.databasePropertiesFile as String,
        ...
        "--file", config.perf.flight.domain.airplanes.file as String,
