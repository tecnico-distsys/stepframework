package step.examples.tripplanner.flight.ws.client;

import step.examples.tripplanner.flight.ws.FlightPortType;
import step.examples.tripplanner.flight.ws.FlightService;
...
public class FlightStubFactory extends
	...
	//
	public final static String ENDPOINT_ADDRESS_CONFIG_PARAMETER_NAME = "step.examples.tripplanner.flight.ws.EndpointAddress";
