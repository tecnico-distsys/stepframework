...
public class PopulateTestDomain {
    ...
    protected static void populateClients(Session session) throws MediatorDomainException {
    ...
    protected static void populateReservations(Session session) throws Exception {
