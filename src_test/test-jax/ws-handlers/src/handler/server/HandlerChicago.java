    ...
    public boolean handleMessage(SOAPMessageContext smc) {
        ...
        if (outboundProperty.booleanValue()) {
            ...
            if(false) {
                ...
                throw new SOAPFaultException(handler.XMLUtil.createFault("Server Outbound - SOAP Fault!"));
            }
            if(false) {
            ...
            if(false) {
                System.out.println(this + " throwing soap fault exception");
                throw new SOAPFaultException(handler.XMLUtil.createFault("Server Inbound - SOAP Fault!"));
            }
            if(false) {
                System.out.println(this + " returning false");
                return false;
