...
public class DynamicPolicyPipeFactory extends PipeFactory {
	...
	public ServiceInterceptorPipe createServiceInterceptorPipe(Service svc) throws ExtensionException
	{
		try
		{
			...
			List<Assertion> alternative = chooseAlternative(svc, policy);
	...
	public WebServiceInterceptorPipe createWebServiceInterceptorPipe(SOAPMessageContext smc) throws ExtensionException
	{
		try
		{
			...
			List<Assertion> alternative = chooseAlternative(smc, policy);
			log.trace("Loading extensions");
			List<Extension> exts = getExtensions(alternative);
			log.trace("Loading interceptors");
	...
	protected List<Assertion> chooseAlternative(SOAPMessageContext smc, Policy policy) throws ExtensionException
	{
		return chooseAlternative(policy);
	}
	
	@SuppressWarnings("unchecked")
	protected List<Assertion> chooseAlternative(Service svc, Policy policy) throws ExtensionException
	{
		return chooseAlternative(policy);
	}
	
	@SuppressWarnings("unchecked")
	private List<Assertion> chooseAlternative(Policy policy) throws ExtensionException
	{
