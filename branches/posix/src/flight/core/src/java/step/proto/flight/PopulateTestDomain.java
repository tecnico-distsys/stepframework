...
import step.proto.flight.domain.Airplane;
import step.proto.flight.domain.Airport;
import step.proto.flight.domain.Flight;
import step.proto.flight.domain.FlightManager;
import step.proto.flight.domain.FlightReservation;
import step.proto.flight.domain.Passenger;
...
public class PopulateTestDomain {
	...
	try {
	    ...
	    System.out.println("Error creating persistence session or transaction");
	...
	try {
	    ...
	    System.out.println("Error populating domain due to constraints violation");
	    System.out.println(e.getClass());
	    System.out.println(e.getMessage());
	    System.out.println("This probably means that the domain is already populated");
	} catch (Exception e) {
	...
	{
	    Airport airport = new Airport("Lisbon", new BigDecimal("1000")).init();
	    manager.addAirport(airport);
	}
	{
	    Airport airport = new Airport("London", new BigDecimal("2000")).init();
	    manager.addAirport(airport);
	}
	{
	    Airport airport = new Airport("New York", new BigDecimal("2500")).init();
	    manager.addAirport(airport);
	}
	{
	    Airport airport = new Airport("Rochester", new BigDecimal("1500")).init();
	    manager.addAirport(airport);
	}
	{
	    Airport airport = new Airport("Seoul", new BigDecimal("2150")).init();
	    manager.addAirport(airport);
	}
    }
	...
	{
	    Airplane airplane = new Airplane("XY100", "Boeing 767", 220, new BigDecimal("10000")).init();
	    manager.addAirplane(airplane);
	}
	{
	    Airplane airplane = new Airplane("ZX200", "Airbus A320", 235, new BigDecimal("10350")).init();
	    manager.addAirplane(airplane);
	}
	{
	    Airplane airplane = new Airplane("XP300", "Airbus A380", 400, new BigDecimal("20000")).init();
	    manager.addAirplane(airplane);
	}
    }
	...
	{
	    Passenger passenger = new Passenger("L4532602", "John Williams").init();
	    manager.addPassenger(passenger);
	}
	{
	    Passenger passenger = new Passenger("L4588542", "Mark Spencer").init();
	    manager.addPassenger(passenger);
	}
	{
	    Passenger passenger = new Passenger("95733331", "Anne Smith").init();
	    manager.addPassenger(passenger);
	}
	{
	...
	System.out.println("Populating Flights...");
	{
	    ...
	    Flight flight = new Flight("LIS-NY-1", dateTime, new BigDecimal("1.2"), origin, destination, airplane, 4).init();
	...
	}
	{
	    ...
	    Flight flight = new Flight("NY-ROC-1", dateTime, new BigDecimal("1.3"), origin, destination, airplane, 2).init();
	    manager.addFlight(flight);
	}
    }
	...
	System.out.println("Populating Flight Reservations...");
	{
		...
		FlightReservation flightReservation = new FlightReservation(flight.getNumber() + "-1", passenger, flight).init();
		...
		FlightReservation flightReservation = new FlightReservation(flight.getNumber() + "-2", passenger, flight).init();
		flight.addReservation(flightReservation);
	    }
	    {
		Criteria criteria = session.createCriteria(Passenger.class);
		...
		FlightReservation flightReservation = new FlightReservation(flight.getNumber() + "-3", passenger, flight).init();
		flight.addReservation(flightReservation);
	    }
	    {
		Criteria criteria = session.createCriteria(Passenger.class);
		...
		FlightReservation flightReservation = new FlightReservation(flight.getNumber() + "-4", passenger, flight).init();
		flight.addReservation(flightReservation);
	    }
	}
	{
